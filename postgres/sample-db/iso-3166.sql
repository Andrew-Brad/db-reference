-- File originally sourced from: https://github.com/morenoh149/postgresDBSamples/blob/master/iso-3166/iso-3166.sql
-- If using a psql client: psql -d "postgres://<user>:<password>@<hostname>/periodic_table" -f iso-3166.sql
-- If psql is not available, but running postgres on docker: docker exec -i <containerId> psql -U <user> < iso-3166.sql
